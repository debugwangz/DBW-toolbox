...
# from https://github.com/vtsynergy/2D-DECT/blob/510ce112c41bd0aff9cffee3555bf13d23a7cba7/code/train_main2_jy.py
...
def ssim(img1, img2, window_size=11, window=None, size_average=True, full=False, data_range=None):
...
def msssim(img1, img2, window_size=11, size_average=True, data_range=None, normalize=None):
    device = img1.device
    ...
    for _ in range(levels):
        sim, cs = ssim(img1, img2, window_size=window_size, size_average=size_average, full=True, data_range=data_range)
...
class MSSSIM(torch.nn.Module):
    ...
    def forward(self, img1, img2, data_range=None):
        ...
        return msssim(img1, img2, window_size=self.window_size, size_average=self.size_average,
                      data_range=data_range,normalize="simple")
        #return msssim(img1, img2, window_size=self.window_size, size_average=self.size_average)
